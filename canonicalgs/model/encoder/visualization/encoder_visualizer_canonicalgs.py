...
from ..encoder_canonicalgs import EncoderCanonicalGS
# from ..epipolar.epipolar_sampler import EpipolarSampling
from .encoder_visualizer import EncoderVisualizer
from .encoder_visualizer_canonicalgs_cfg import EncoderVisualizerCanonicalGSCfg
...
class EncoderVisualizerCanonicalGS(
    EncoderVisualizer[EncoderVisualizerCanonicalGSCfg, EncoderCanonicalGS]
):
    def visualize(
        self,
